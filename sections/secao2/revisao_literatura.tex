...
\begin{figure}[htb]
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{ComparisonofMemoryConsumptionofSearchingAlgorithm.png}
    ...
    \begin{minipage}{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{ComparisonofTimeUtilizationofSearchingAlgorithm.png}
